        ...
        {campaigns.map(campaign => (
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-between pl-4 pr-6 py-2 hover:bg-muted/30 transition-colors"
            >
            ...
            {expandedId === campaign.id && (
              <div className="border-t border-border pl-4 pr-6 py-4 space-y-3 bg-background/50">
